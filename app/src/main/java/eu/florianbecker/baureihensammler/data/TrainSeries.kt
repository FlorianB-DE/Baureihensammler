...
object AlphaTrainSeriesRepository {
    val items: List<TrainSeries> = listOf(
        ...
        TrainSeries("1441", "Coradia Continental", "Triebzug", 160, 80, "Alstom_Coradia_Continental"),
        TrainSeries("442", "Talent 2", "Triebzug", 160, 250, "DB-Baureihe_442"),
        TrainSeries("443", "Talent 2", "Triebzug", 160, 250, "Bombardier_Talent_2"),
        TrainSeries("1442", "Talent 2", "Triebzug", 160, 150, "Bombardier_Talent_2"),
        TrainSeries("1443", "Talent 2", "Triebzug", 160, 150, "Bombardier_Talent_2"),
        TrainSeries("2442", "Talent 2", "Triebzug", 160, 100, "Bombardier_Talent_2"),
        TrainSeries("2443", "Talent 2", "Triebzug", 160, 100, "Bombardier_Talent_2"),
        TrainSeries("3442", "Talent 2", "Triebzug", 160, 100, "Bombardier_Talent_2"),
        TrainSeries("3443", "Talent 2", "Triebzug", 160, 100, "Bombardier_Talent_2"),
        TrainSeries("8442", "Talent 2", "Triebzug", 160, 40, "Bombardier_Talent_2"),
        TrainSeries("8443", "Talent 2", "Triebzug", 160, 40, "Bombardier_Talent_2"),
        TrainSeries("6442", "Talent 3+", "Triebzug", 160, 40, "Bombardier_Talent_3"),
        TrainSeries("6443", "Talent 3+", "Triebzug", 160, 40, "Bombardier_Talent_3"),
        TrainSeries(
